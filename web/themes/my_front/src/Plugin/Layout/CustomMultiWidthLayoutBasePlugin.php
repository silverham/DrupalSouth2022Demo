...
/**
 * Custom Multi-width base layout class plugin.
 */
abstract class CustomMultiWidthLayoutBasePlugin extends CustomDefaultLayoutPlugin implements PluginFormInterface {
